...
public class BMPTool extends Activity {
    ...
    public void saveBmp(Bitmap bitmap)
    {
        	...
        	//String filename = "/storage/sdcard0/encoded/" + "/temp" + ".bmp"; 
                ...
                //FileOutputStream fileos = new FileOutputStream("/storage/sdcard0/encoded/"+"temp.bmp");
                FileOutputStream fileos = new FileOutputStream(MainActivity.OUTPUT_PATH+"temp.bmp");
                    // bmp文件头
                    int bfType = 0x4d42;
