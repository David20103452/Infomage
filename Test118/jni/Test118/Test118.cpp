...
{
	int			yy;
	int			nJpegLineBytes;			//JPEG1���C���̃o�C�g��
	int test=0;
//	int array[1536];
	...
	cinfo.err = jpeg_std_error(&jError);			//�G���[�n���h���ݒ�
	jError.error_exit = _JpegError;					//�G���[�n���h���ݒ�
...
//	__android_log_print(ANDROID_LOG_INFO, "num", "number=%d",num);
	jsize len = env->GetArrayLength(arr);//�����������ĳ���..
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
extern "C"
JNIEXPORT jintArray JNICALL Java_com_algorithms_F5Algorithm_RenderBitmap(JNIEnv * env, jobject  obj, jobject bitmap, jintArray arr, jstring imagePath, jint num)
{
//	AndroidBitmapInfo  info;
//	void*			  pixels;
//	int				ret;
...
extern "C"
JNIEXPORT void JNICALL Java_com_algorithms_F5Algorithm_createImage(JNIEnv * env, jobject  obj, jintArray arr, jstring imagePath, jstring outputPath, jint num)
{
	int			yy;
	int			nJpegLineBytes;			//JPEG1���C���̃o�C�g��
	int test=0;
...
extern "C"
JNIEXPORT jintArray JNICALL Java_com_algorithms_F5Algorithm_decodeEmbededImage(JNIEnv * env, jobject  obj, jintArray arr, jstring imagePath, jint num)
{
	int			yy;
		int			nJpegLineBytes;			//JPEG1���C���̃o�C�g��
		int test=0;
